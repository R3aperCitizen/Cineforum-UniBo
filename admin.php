...
<html class="" lang="en"><head>
    ...
    <title>UniBo Cineforum | Admin</title>
    ...
    <main class="max-w-screen-2xl mx-auto px-12 py-16">
        ...
        <section class="mb-24">
            ...
            <div class="bg-surface-container-low rounded-lg p-8 mb-8">
                <h3 class="font-['Epilogue'] text-sm font-bold uppercase tracking-[0.2em] text-on-surface-variant mb-6">Aggiungi un nuovo film</h3>
                <form class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" max="10" class="w-full bg-surface-container-high border-b-2 border-outline-variant/20 focus:border-outline-variant focus:outline-none px-4 py-3 font-body transition-colors">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
            ...
            <div class="bg-surface-container-low rounded-lg overflow-hidden">
                <div class="p-6 border-b border-neutral-800/50">
                    <h3 class="font-['Epilogue'] text-sm font-bold uppercase tracking-[0.2em] text-on-surface-variant">Elenco Film</h3>
                </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-surface-container-high">
                            <tr>
                                ...
                                <th class="px-6 py-4 font-['Epilogue'] text-xs uppercase tracking-widest text-on-surface-variant text-left">Genere</th>
                                <th class="px-6 py-4 font-['Epilogue'] text-xs uppercase tracking-widest text-on-surface-variant text-center">Voto</th>
        ...
        <section class="mb-24">
            ...
            <div class="bg-surface-container-low rounded-lg overflow-hidden">
                <div class="p-6 border-b border-neutral-800/50">
                    <h3 class="font-['Epilogue'] text-sm font-bold uppercase tracking-[0.2em] text-on-surface-variant">Elenco Eventi</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-surface-container-high">
