...
<span class="bg-primary-container text-white px-3 py-1 font-body text-xs tracking-widest uppercase">Tonight 21:00</span>
<span class="text-tertiary font-body text-xs tracking-widest uppercase">Aula Magna, Santa Lucia</span>
</div>
<h1 class="text-7xl md:text-9xl font-medium tracking-tight mb-8 leading-none">The Seventh Seal</h1>
<p class="max-w-xl font-body text-lg text-secondary leading-relaxed mb-10">
    Ingmar Bergman's masterpiece explores the human condition through a medieval knight's chess match with Death. A profound meditation on faith, doubt, and the silence of God.
</p>
...
<div>
<h2 class="text-5xl font-medium tracking-tight text-white mb-4">Autumn Schedule</h2>
...
<h4 class="font-body font-bold text-xs uppercase tracking-[0.3em] text-primary-container mb-8">Announcements</h4>
<div class="space-y-12">
<div class="group cursor-pointer">
<span class="text-tertiary font-body text-[10px] uppercase tracking-widest block mb-2">02 Oct 2023</span>
<h5 class="text-xl font-medium mb-3 group-hover:text-primary-container transition-colors">Call for Student Volunteers: Winter Festival</h5>
...
<h5 class="text-xl font-medium mb-3 group-hover:text-primary-container transition-colors">Digital Archive Now Accessible to Researchers</h5>
