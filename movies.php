    ...
    <main class="max-w-screen-2xl flex-1 mx-auto px-12 py-16">
        ...
        <div class="flex flex-col lg:flex-row gap-16">
            ...
            <aside class="w-full lg:w-64 flex-shrink-0 space-y-12">
                ...
                <div>
                    <h2 class="font-['Epilogue'] text-xs font-bold uppercase tracking-[0.2em] text-[#B31E24] mb-6">Generi</h2>
                    <ul class="space-y-4 font-['Epilogue'] text-sm">
                        <?php renderGenres(); ?>
                    </ul>
                </div>
                <div>
                    <h2 class="font-['Epilogue'] text-xs font-bold uppercase tracking-[0.2em] text-[#B31E24] mb-6">Registi</h2>
                    <ul class="space-y-4 font-['Epilogue'] text-sm">
                        <?php renderDirectors(); ?>
                    </ul>
                </div>
