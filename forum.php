...
<span class="">Cineforum 2024</span>
<span class="material-symbols-outlined text-[10px]">chevron_right</span>
<span class="text-[#B31E24]">The Logic of SHAdows</span>
</nav>
<h1 class="text-7xl md:text-8xl font-medium tracking-tight mb-8 leading-none text-[#000000]">The Logic of <span class="text-primary-container">Shadows</span></h1>
<p class="font-['Epilogue'] text-lg leading-relaxed text-[#000000] max-w-2xl mb-12">
    An in-depth analysis of mid-century cinematic expressionism and its sociological impact on post-war European identity. This session explores the architectural use of light and the narrative weight of silence.
</p>
<div class="flex items-center space-x-12">
<div class="flex flex-col">
<span class="font-['Epilogue'] text-[10px] uppercase tracking-widest mb-1">Date</span>
<span class="font-['EB_Garamond'] text-xl">24 November 2024</span>
</div>
<div class="flex flex-col">
<span class="font-['Epilogue'] text-[10px] uppercase tracking-widest mb-1">Location</span>
<span class="font-['EB_Garamond'] text-xl">Aula Magna, Via Zamboni</span>
</div>
<div class="flex flex-col">
<span class="font-['Epilogue'] text-[10px] uppercase tracking-widest mb-1">Status</span>
...
<img class="w-full h-full object-cover grayscale opacity-80 hover:opacity-100 transition-opacity duration-700" data-alt="stark black and white cinematic still showing dramatic shadows on a geometric concrete staircase in post-war architectural style" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBblGfNv8mEqJXxmQ7JObMt1Ur6fY9CrlzibZzysmWRvqspt0J5V81dn-6w4d1nU_hGcS5SXV8w1lCwRKkqw-EGxf54HAfsA3ZHjw52ZS_zniYqRRV9z4_i72-WNjoqeX0alty4oWxXtGaltuijt209JD-2X1zUCY2itS9DZyfb8x0fVbQ7L7fro8LZTuXobqDvBoBUb8KqJ9ZQbVl1dYyIrSKgfud2pH2In6LQEO4egJ1PpJSD9v1xrQIoQK-2Nhu87mzSzzFoQyQ"/>
</div>
</div>
</section>
<!-- Asymmetric Content Grid -->
<div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
<!-- Left Column: Synopsis & Speakers -->
...
<!-- Speaker Bios -->
<section>
<h2 class="text-4xl font-medium mb-12 text-[#000000]">Faculty &amp; Speakers</h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-12">
<div class="group">
<div class="aspect-square bg-surface-container-high mb-6 overflow-hidden">
<img class="w-full h-full object-cover grayscale transition-all duration-500 group-hover:grayscale-0" data-alt="professional portrait of an elderly man with glasses in a library setting, dark suit, scholarly appearance, soft directional lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWZLWvoSLjcl5hzZQKKvPJrdc_K0zHlGEd7g7WK-Dpaklqb9z5q7b27DLpjP-NLvSUJHFQpnp8wvHNV948MCIb8WOnRHNcasXT9U7C8UrMHlSqGoRmGj1_SuYOe8eKYU-6v_GSr2C-uADlN0GIcLrBamjo7f4d58EA2NhZtVhg0XG-1BDlQrvIgPtQLHDcdG5EV5UIX6OGCrut7KITCvomlym3DLZTCJCuSiJmI5H6f8enNJT3qRD6uR3Og6R9_6GGQPTwrSTdBnI"/>
</div>
<h3 class="text-3xl mb-2 text-[#000000]">Prof. Marco Rossi</h3>
<span class="font-['Epilogue'] text-xs uppercase tracking-widest text-primary-container font-bold block mb-4">Department of Visual Arts</span>
<p class="font-['Epilogue'] text-[#000000] text-sm leading-relaxed">
    A leading authority on European cinema, Professor Rossi has published extensively on the relationship between urban architecture and the moving image. His latest monograph explores the silent era's influence on modern digital storytelling.
</p>
</div>
<div class="group">
<div class="aspect-square bg-surface-container-high mb-6 overflow-hidden">
<img class="w-full h-full object-cover grayscale transition-all duration-500 group-hover:grayscale-0" data-alt="professional portrait of a middle-aged woman with dark hair, focused expression, intellectual look, neutral studio background" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAUk3RxIt9m032AHZb8BNWKKY6yZlzZ3Tm_oiS9Uz_1asMjEw4lEy73uV32wEomKo5TetGxPigd2408mm-nrvCGmMMzJXKmDEVgHcgxuLlQdQ1s4ezoQFiXG5E_nydBJ_lNLCAjAR5xh_v9DyTGqgO3ke1WS08h3Hp4gdFM6nlkvizaWXLcvacbzIo7CaBVtqL59QyGaR1bxi6nTunOazy8LLDwNr3JS65KN_IwKBNIjZcaEs0joSDiT9QiDec787Kqn_bpnYK6JZM"/>
</div>
<h3 class="text-3xl mb-2 text-[#000000]">Dott.ssa Elena Bianchi</h3>
<span class="font-['Epilogue'] text-xs uppercase tracking-widest text-primary-container font-bold block mb-4">Film Preservation Specialist</span>
<p class="font-['Epilogue'] text-[#000000] text-sm leading-relaxed">
    Dott.ssa Bianchi oversees the restoration projects at the University's digital archive. Her research focuses on the chemical evolution of film stock and the preservation of tactile qualities in digital replicas.
</p>
</div>
</div>
</section>
...
<h3 class="text-xl mb-6 text-[#000000]">Suggested Reading</h3>
<ul class="space-y-6">
<li class="">
<a class="group block" href="#">
<span class="font-['Epilogue'] text-[10px] uppercase mb-1 block">Rossi, M. (2022)</span>
<span class="text-lg leading-tight text-[#000000] group-hover:text-primary transition-colors">The Architecture of Silence: Shadows in Cinema</span>
</a>
</li>
<li class="">
<a class="group block" href="#">
<span class="font-['Epilogue'] text-[10px] uppercase mb-1 block">Bianchi, E. (2023)</span>
<span class="text-lg leading-tight text-[#000000] group-hover:text-primary transition-colors">Tactile Light: Restoration Challenges</span>
</a>
</li>
</ul>
</div>
