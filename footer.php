...
<div class="flex flex-col md:flex-row justify-between items-center w-full px-12 py-10 border-t border-neutral-800 max-w-screen-2xl mx-auto">
<div class="mb-8 md:mb-0">
<div class="font-['EB_Garamond'] text-lg font-semibold mb-2 text-white">Alma Mater Studiorum</div>
<div class="font-['Epilogue'] text-xs font-light tracking-wide uppercase text-neutral-100">Università di Bologna • Cineforum Project</div>
</div>
...
<div class="font-['Epilogue'] text-xs font-light tracking-wide text-neutral-100">
    © 1088-2024 Alma Mater Studiorum - Università di Bologna. All rights reserved.
</div>
</div>
</div>
</footer>